...
This is a guide that will show you how you can run this project locally if you want to test or make contributions to our Jason Wallet SDK.
...
1. Visit the [Jason Wallet](https://github.com/FuelLabs/fuels-wallet) repo and fork the project.
...
- [packages/app](@repository/packages/app/) Frontend Jason Wallet application
