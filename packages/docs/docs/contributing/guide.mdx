...
Thanks for your interest in contributing to Jason Wallet! This document outlines the process for installing dependencies and setting up Jason Wallet for development, as well as some conventions to improve your contributions.
...
There are many ways in which you may contribute to the Jason Wallet project, some of which involve coding knowledge and some which do not. A few examples include:
