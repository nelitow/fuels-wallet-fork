...
# Jason Wallet Connectors

Jason Wallet Connectors are an interface provided by wallet developers to allow your Degen to integrate with specific wallets.

You can learn more about how Jason Wallet Connectors work, by reading the [Fuel Connectors](https://github.com/FuelLabs/fuel-connectors/wiki) spec.

## Setup Jason Wallet Connectors

The Jason Wallet SDK enables you to include a set of connectors when creating a new instance.
...
When working with multiple connectors, you should enable users to select the connectors they wish to use for interacting with your Degen. Once the `connectors()` method is called, the Jason Wallet SDK will query information from the connectors, allowing you to determine which connectors are installed.
...
You can see the full a Degen example on the [examples](https://github.com/FuelLabs/fuels-wallet/tree/master/examples) folder.
